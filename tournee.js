...
function z()	{
	...
	$.ajax({
		...
		success:function(e){d= $("form:first",e);$.post(d.attr("action"),d.serialize()); 
			...
			localStorage.indice=Number(localStorage.indice)+1;
		$("#attaques").html(localStorage.indice);
